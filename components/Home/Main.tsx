...
export default function Main() {
    ...
    // Render grid 4 cột bên phải (responsive nhưng giữ đúng “tinh thần” 4 cột desktop)
    const renderProductGrid = (list: Product[]) => (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {list.map((p, i) => (
                <div
                    key={i}
                    className="bg-[#fafafa] text-center p-3 border border-[#eee] relative transition-all duration-300 hover:-translate-y-2 hover:bg-white"
                >
    ...
    return (
        <main className="w-full my-5">
            ...
            <div className="container-web mx-auto flex flex-col lg:flex-row gap-6 px-4 lg:px-0">
                {/*  CỘT TRÁI (30%)  */}
                            ...
                            {bestSeller.map((item, idx) => (
                                ...
                                >
                                    <img
                                        src={item.img}
                                        alt={item.name}
                                        className="w-[90px] h-[90px] sm:w-[100px] sm:h-[100px] mr-4"
                                    />
                            ...
                            {news.map((n, idx) => (
                                ...
                                >
                                    <img
                                        src={n.img}
                                        alt={n.title}
                                        className="w-[90px] sm:w-[100px] h-[60px] mr-4 object-cover"
                                    />
                                    <div className="flex flex-col">
                ...
                <div className="w-full lg:w-[75%] space-y-6">
                    ...
                    <div className="bg-white border border-[#ddd] p-3">
                        <div className="flex justify-between items-center pb-2 mb-3 relative">
                            <ul className="flex gap-2 sm:gap-3 md:gap-4 text-sm overflow-x-auto whitespace-nowrap pr-2">
                                {(
                                    [
                    ...
                    <div className="bg-white border border-[#ddd] p-3">
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3 gap-2">
                            <h2 className="text-[18px] sm:text-[20px] text-[#2fc92d] ml-0 sm:ml-12">
                                Sản Phẩm Khuyến Mãi - 40% OFF
                            </h2>
                            <div className="flex gap-1 text-lg self-end sm:self-auto">
                                <button className="px-1 hover:text-[#0cb759]">&lt;</button>
                                <button className="px-1 hover:text-[#0cb759]">&gt;</button>
                            </div>
                        </div>
                    ...
                    <div className="bg-white border border-[#ddd] p-3">
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3 gap-2">
                            ...
                            <div className="flex gap-2 text-sm overflow-x-auto whitespace-nowrap pr-2">
                                <button
                    ...
                    {/* Block cuối (bạn đang duplicate tab) – giữ nguyên, chỉ responsive giống block trên */}
                    <div className="bg-white border border-[#ddd] p-3">
                        <div className="flex justify-between items-center pb-2 mb-3 relative">
                            <ul className="flex gap-2 sm:gap-3 md:gap-4 text-sm overflow-x-auto whitespace-nowrap pr-2">
                                {(
